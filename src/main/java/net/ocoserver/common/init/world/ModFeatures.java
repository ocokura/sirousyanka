...
public class ModFeatures {
    ...
    public static final DeferredHolder<Feature<?>, Feature<NoneFeatureConfiguration>> ABYSS_ICE_SPIKE = FEATURES.register("abyss_ice_spike", () -> new AbyssIceSpikeFeature(NoneFeatureConfiguration.CODEC));
