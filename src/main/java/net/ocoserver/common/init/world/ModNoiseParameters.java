...
public class ModNoiseParameters {
    ...
    public static final ResourceKey<NormalNoise.NoiseParameters> FROZEN_ABYSS_BASE_MOUNTAIN_NOISE = ModUtils.getResourceKey(Registries.NOISE, "frozen_abyss_base_mountain_noise");
    public static final ResourceKey<NormalNoise.NoiseParameters> FROZEN_ABYSS_SMALL_MOUNTAIN_NOISE = ModUtils.getResourceKey(Registries.NOISE, "frozen_abyss_small_mountain_noise");
    ...
    public static void bootstrap(BootstrapContext<NormalNoise.NoiseParameters> context) {
        ...
        context.register(FROZEN_ABYSS_BASE_MOUNTAIN_NOISE, new NormalNoise.NoiseParameters(-8, 3));
        context.register(FROZEN_ABYSS_SMALL_MOUNTAIN_NOISE, new NormalNoise.NoiseParameters(-3, 1));
