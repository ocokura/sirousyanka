...
public class ModTreeGrowers {
    ...
    public static final TreeGrower CLOWD_TREE_GROWER = new TreeGrower(Sirousyanka.MODID + ":" + "clowd_tree_grower", Optional.empty(), Optional.of(TreeConfigure.CLOWD_TREE), Optional.empty());
