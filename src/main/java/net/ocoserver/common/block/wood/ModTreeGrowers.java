...
public class ModTreeGrowers {
    ...
    public static final TreeGrower NITROWD_TREE = new TreeGrower(Sirousyanka.MODID + ":" + "nitrowd_tree", Optional.empty(), Optional.of(TreeConfigure.NITROWD_TREE_KEY), Optional.empty());
}
