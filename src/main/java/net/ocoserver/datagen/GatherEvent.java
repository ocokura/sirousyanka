...
import net.ocoserver.datagen.datapack.ModDatapackProvider;
...
public class GatherEvent {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        event.getGenerator().addProvider(
                event.includeServer(),
                (DataProvider.Factory<ModDatapackProvider>) output -> new ModDatapackProvider(output, event.getLookupProvider())
        );
